...
Mn = st.slider('Mn (Number-average molecular weight)', min_value=1000.0, max_value=50000.0, step=1000.0, value=10000.0)
PDI = st.slider('PDI (Polydispersity index)', min_value=1.1, max_value=3.0, step=0.1, value=1.5)
temperature = st.slider('Temperature (K)', min_value=250.0, max_value=500.0, step=10.0, value=300.0)
