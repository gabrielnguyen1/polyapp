...
gel_point = st.slider('Gel Point (mol/L)', min_value=0.1, max_value=1.0, step=0.1, value=0.5)
diffusion_factor = st.slider('Diffusion Factor', min_value=0.1, max_value=1.0, step=0.1, value=0.8)
